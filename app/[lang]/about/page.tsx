  ...
  const facultyMembers = [
    {
      ...
      image: "/images/faculty/dr-aida-nazarova.jpg",
      specialization: "Computer Science & AI",
    },
    {
      name: "Prof. Bakyt Orozov",
      position: "Head of Business Studies",
      image: "/images/faculty/prof-bakyt-orozov.jpg",
      specialization: "International Business",
    },
    {
      name: "Dr. Gulnara Asanova",
      position: "Director of Research",
      image: "/images/faculty/dr-gulnara-asanova.jpg",
        ...
        <section className="mb-12">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative h-64 md:h-80">
              <Image src="/images/campus-building.jpg" alt="College Campus" fill className="object-cover rounded-lg" />
            </div>
          </div>
        </section>
